// BOD3D-TEST v11.59 — restore reliable hero loading; keep compact combat items and prior fixes
(function(){
  ...
  function loadEnterButtonRuntime(){loadScriptOnce('script[data-bod-enter-button-black]','assets/enter-button-black.js?v=11.59','bodEnterButtonBlack');}
