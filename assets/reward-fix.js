// BOD3D-TEST v11.60 — North-facing hero patch removed; restore original hero loading and orientation
(function(){
  ...
  function loadEnterButtonRuntime(){loadScriptOnce('script[data-bod-enter-button-black]','assets/enter-button-black.js?v=11.60','bodEnterButtonBlack');}
