// BOD3D-TEST v11.49 — improved mobile warning scroll, refined dark HUD, red Quest Log combat events and responsive fixes
(function(){
  const VERSION='v11.49';
  ...
  function loadLethalBlow(){loadScriptOnce('script[data-bod-lethal-blow]','assets/lethal-blow.js?v=11.49','bodLethalBlow');}
  function loadMobileSheetFix(){loadScriptOnce('script[data-bod-mobile-sheet-fix]','assets/mobile-sheet-fix.js?v=11.49','bodMobileSheetFix');}
  function loadQuestLogColours(){loadScriptOnce('script[data-bod-quest-log-colours]','assets/quest-log-colours.js?v=11.49','bodQuestLogColours');}
  function loadWarningScrollStyles(){loadStyleOnce('link[data-bod-warning-scroll]','css/warning-scroll.css?v=11.49','bodWarningScroll');}
  function loadDesktopHudStyles(){loadStyleOnce('link[data-bod-desktop-hud]','css/desktop-hud.css?v=11.49','bodDesktopHud');}
  function loadDarkCombatStyles(){loadStyleOnce('link[data-bod-dark-combat]','css/dark-combat.css?v=11.49','bodDarkCombat');}
  function loadDarkHudStyles(){loadStyleOnce('link[data-bod-dark-hud]','css/dark-hud.css?v=11.49','bodDarkHud');}
